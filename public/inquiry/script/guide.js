            ...
            $scope.$watch("type+selectValue", function () {
                if ($scope.type == 0) {
                    ...
                    $scope.changeStatus = function (event) {
                        ...
                        lastTimeStatus = $scope.selectValue.options.filter(function (value, index) {
                    ...
                    $scope.changeValue = function (event) {
                        ...
                        switch (attr) {
                            case "cancel":
                                if (lastTimeStatus != "") {
                                    $scope.selectValue.options.filter(function (obj) {
                                ...
                                break;
                            case "sure":
                                var valueList = $scope.selectValue.options.filter(function (data, index) {
                    ...
                    $scope.changeOptions = function (index, event) {
                        event.stopPropagation();
                        $scope.selectValue.options.forEach(function (value) {
                    ...
                    $scope.$watch("showPoint+complainValue+pointMsg+guideData", function () {
                        ...
                        $scope.submitComplain = function () {
                            ...
                            if (length == 0) {
                                ...
                                var content = $scope.complainValue.value;
                                $scope.showPoint = false;
                                $http({
                                    method: 'POST',
