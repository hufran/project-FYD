(function (global, factory) {
    ...
    (function (global, factory) {
         ...
         */
        (function (global) {
            var tmpl = "<div class='popup_container' ng-style='containerSize'>" + "<div class='popup_title'>" + "<span class='title_name'>提示</span><a class='close_btn' href='javascript:void(0)'>关闭</a>" + "</div>" + "<div class='popup_content'></div>" + "<div class='popup_btnGroup'>" + "</div>" + "</div>" + "<div class='overlayer'></div>";
